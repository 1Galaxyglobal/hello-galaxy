...
# 1. WenQuanYi（首选中文字体）
_CHINESE_FONT_PATH = '/usr/share/fonts/truetype/wqy/wqy-microhei.ttc'
if _register_font_safe('WenQuanYi', _CHINESE_FONT_PATH):
...
for _p in [
    ...
    if _register_font_safe('NotoSansSC', _p):
        break

# 3. MiSans
_register_font_safe('MiSans', '/usr/share/fonts/truetype/misans/MiSans-Regular.ttf')

# 4. Alibaba PuHuiTi
_register_font_safe('AliPuHui', '/usr/share/fonts/truetype/alibaba-puhuiti/AlibabaPuHuiTi-2-55-Regular.ttf')

# 5. 英文/数字字体备选
for _p in [
    '/usr/share/fonts/truetype/noto/NotoSansSC-Light.ttf',
]:
    if _register_font_safe('NotoSansLight', _p):
        break
...
def get_best_font_for_text(text, preferred=None):
    ...
    if has_chinese:
        # 优先返回第一个可用的中文字体
        for fn in [CHINESE_FONT, 'NotoSansSC', 'MiSans', 'AliPuHui']:
